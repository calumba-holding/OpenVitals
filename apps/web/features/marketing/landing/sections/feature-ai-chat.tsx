      ...
      <div className="mx-auto max-w-[1120px] px-6 py-20">
            ...
            <div className="rounded-lg border border-neutral-200/80 bg-white overflow-hidden" style={{ boxShadow: '0 1px 4px rgba(0,0,0,0.04)' }}>
              <div className="flex flex-col gap-3 p-4">
                <div className="flex justify-end">
                  <div className="max-w-[70%] rounded-[12px_12px_4px_12px] bg-accent-500 px-3 py-2 text-[11px] leading-relaxed text-white font-body">
                ...
                <div className="flex gap-2">
                  ...
                  <div className="space-y-1.5">
                    <span className="text-[7px] font-semibold uppercase tracking-[0.06em] text-accent-500 font-mono">OpenVitals AI</span>
                    <div className="rounded-[4px_12px_12px_12px] border border-neutral-200 bg-white px-3 py-2 text-[11px] leading-[1.6] text-neutral-700 font-body">
                    ...
                    <div className="flex flex-wrap gap-1">
                      {['◎ 6 observations', '◷ Mar 2025–2026', '⟐ Quest + LabCorp'].map(p => (
                        <span key={p} className="rounded bg-secondary-50 border border-secondary-200 px-1.5 py-0.5 text-[7px] text-neutral-500 font-mono">{p}</span>
                      ))}
                    </div>
                  </div>
                </div>
              ...
              <div className="border-t border-neutral-100 px-3 py-2 flex items-center gap-2">
                <div className="flex-1 rounded-lg bg-neutral-50 px-3 py-1.5">
                  <span className="text-[10px] text-neutral-400 font-body">Ask about your health data...</span>
                </div>
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
          <div>
            ...
            <p className="mt-3 text-[14px] leading-[1.7] text-neutral-500 font-body">
